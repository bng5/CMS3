                      ...
                      <tr>
                        <td class="ampliacion">
                         <div class="ampliacion">
						  ...
						  <h3>'.str_replace(" ", "&nbsp;", wordwrap($item["valores"][6], 13 )).'</h3>';
...
?>
	...
	foreach($items AS $item) {
		...
		$items_txt .= '<td class="item">
				  <div class="itemInt">
					<div class="ol"><span class="d'.$num[0].'"></span><span class="u'.$num[1].'"></span><span class="simb s'.$k.'"></span></div>
					<h3><a name="'.$num.'" href="/'.$seccion->urls[$idioma->cod].'?id='.$item['id'].'&amp;ref='.$i.'">'.str_replace(" ", "&nbsp;", wordwrap($item["string__titulo"], 13 )).'</a></h3>
